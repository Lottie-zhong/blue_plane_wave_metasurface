...
OUT_DIR = ROOT / "outputs/stage10b_v3_h300_p340_phase_raise"
INDEX = OUT_DIR / "stage10b_v3_h300_p340_phase_raise_candidates.csv"
...
# p1 widening / p2 high-phase legal refinement
candidates = [
    ("s10b_v3_p1_105x70_p2_90x125", 105, 70, 90, 125, "p1 wide lower-L + p2 90x125"),
    ("s10b_v3_p1_105x75_p2_90x125", 105, 75, 90, 125, "p1 wider + p2 90x125"),
    ("s10b_v3_p1_105x80_p2_90x125", 105, 80, 90, 125, "p1 widest legal test + p2 90x125"),
    ("s10b_v3_p1_110x70_p2_90x125", 110, 70, 90, 125, "v2 high p1 role + p2 90x125"),
    ("s10b_v3_p1_110x75_p2_90x125", 110, 75, 90, 125, "p1 high-phase legal upper test + p2 90x125"),

    ("s10b_v3_p1_105x75_p2_85x130", 105, 75, 85, 130, "p1 wider + p2 same02"),
    ("s10b_v3_p1_105x80_p2_85x130", 105, 80, 85, 130, "p1 widest + p2 same02"),
    ("s10b_v3_p1_110x75_p2_85x130", 110, 75, 85, 130, "p1 upper legal + p2 same02"),

    ("s10b_v3_p1_105x75_p2_85x135", 105, 75, 85, 135, "p1 wider + p2 85x135"),
    ("s10b_v3_p1_105x80_p2_85x135", 105, 80, 85, 135, "p1 widest + p2 85x135"),
    ("s10b_v3_p1_110x75_p2_85x135", 110, 75, 85, 135, "p1 upper legal + p2 85x135"),

    # A few continuity controls from v2
    ("s10b_v3_ref_v2_110x70_85x130", 110, 70, 85, 130, "v2 high phase control"),
    ("s10b_v3_ref_v2_115x60_90x125", 115, 60, 90, 125, "v2 highest phase control"),
]
...
for cid, p1L, p1W, p2L, p2W, note in candidates:
    ...
    cfg["project"]["stage"] = "stage10b_v3_h300_p340_phase_raise"

    cfg.setdefault("metadata", {})
    cfg["metadata"]["candidate_id"] = cid
    cfg["metadata"]["candidate_family"] = "p340_same_sign_phase_raise"
    cfg["metadata"]["description"] = "Stage10B-v3 p340 strict-valid same-sign phase-raising refinement"
    ...
    result_dir = f"outputs/stage10b_v3_h300_p340_phase_raise/{cid}"
    ...
    rows.append({
        "candidate_id": cid,
        "family": "p340_same_sign_phase_raise",
