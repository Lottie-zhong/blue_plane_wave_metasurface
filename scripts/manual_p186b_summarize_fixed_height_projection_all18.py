...
PLAN = ROOT / "outputs/apcd_k6_active_learning/p185_fixed_height_projection_candidate_plan.csv"
OUT = ROOT / "outputs/apcd_k6_active_learning/p186b_fixed_height_projection_all18_results.csv"
DEC = ROOT / "outputs/apcd_k6_active_learning/p186b_fixed_height_projection_all18_decision.csv"
MD = ROOT / "reports/p186b_fixed_height_projection_all18_results.md"
...
def main() -> int:
    ...
    for p in plan:
        config_path = ROOT / p["config_path"]
        ...
        opens_source = bool(early and nb != "" and int(float(p["source_target_bin_deg"])) == int(nb))

        rows.append({
            "candidate_id": p["candidate_id"],
            "fixed_height_nm": p["fixed_height_nm"],
            "source_target_bin_deg": p["source_target_bin_deg"],
    ...
    for d in decision_rows:
        ...
        lines.append(
            f"| {d['fixed_height_nm']} | {d['tested_count']} | {d['valid_metric_count']} | "
