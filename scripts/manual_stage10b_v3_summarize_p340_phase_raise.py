...
INDEX = ROOT / "outputs/stage10b_v3_h300_p340_phase_raise/stage10b_v3_h300_p340_phase_raise_candidates.csv"
OUT = ROOT / "outputs/stage10b_v3_h300_p340_phase_raise/stage10b_v3_h300_p340_phase_raise_results.csv"
REPORT = ROOT / "reports/stage10b_v3_h300_p340_phase_raise_summary.md"
...
def sort_key(r):
    ...
    return (valid, early, metric, phase, ratio)
