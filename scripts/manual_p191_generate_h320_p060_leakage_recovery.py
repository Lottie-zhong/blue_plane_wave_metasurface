...
OUT_PLAN = ROOT / "outputs/apcd_k6_active_learning/p191_h320_p060_leakage_recovery_plan.csv"
REPORT = ROOT / "reports/p191_h320_p060_leakage_recovery_plan.md"

FIXED_H = 320

BASE_IDS = {
    "crot_m5": "p189_h320_p060_p060_base_crot_m5",
    "crot_m10": "p189_h320_p060_p060_base_crot_m10",
    "crot_m15": "p189_h320_p060_p060_base_crot_m15",
}

VARIANTS = [
    # c_m5: leakage closest to acceptable, phase still 120-bin edge.
    ("crot_m5", "extra_crot_m2p5", "small extra rotation: push phase into 60-bin", [
        {"type": "rotation", "target": "all_core", "delta": -2.5},
    ]),
    ("crot_m5", "extra_crot_m2p5_p1L_m2_p2L_p2", "extra rot plus length contrast recovery", [
        {"type": "rotation", "target": "all_core", "delta": -2.5},
        {"type": "lateral", "target": "p1", "kind": "length", "delta": -2.0},
        {"type": "lateral", "target": "p2", "kind": "length", "delta": 2.0},
    ]),
    ("crot_m5", "extra_crot_m2p5_p1W_m2_p2W_p2", "extra rot plus width contrast recovery", [
        {"type": "rotation", "target": "all_core", "delta": -2.5},
        {"type": "lateral", "target": "p1", "kind": "width", "delta": -2.0},
        {"type": "lateral", "target": "p2", "kind": "width", "delta": 2.0},
    ]),

    # c_m10: already 60-bin, leakage high. Try selectivity recovery.
    ("crot_m10", "p1L_m2_p2L_p2", "60-bin phase-hit, length contrast recovery", [
        {"type": "lateral", "target": "p1", "kind": "length", "delta": -2.0},
        {"type": "lateral", "target": "p2", "kind": "length", "delta": 2.0},
    ]),
    ("crot_m10", "p1W_m2_p2W_p2", "60-bin phase-hit, width contrast recovery", [
        {"type": "lateral", "target": "p1", "kind": "width", "delta": -2.0},
        {"type": "lateral", "target": "p2", "kind": "width", "delta": 2.0},
    ]),
    ("crot_m10", "p2W_p2", "60-bin phase-hit, p2 width +2", [
        {"type": "lateral", "target": "p2", "kind": "width", "delta": 2.0},
    ]),
    ("crot_m10", "p2W_p4", "60-bin phase-hit, p2 width +4", [
        {"type": "lateral", "target": "p2", "kind": "width", "delta": 4.0},
    ]),
    ("crot_m10", "p2L_p2", "60-bin phase-hit, p2 length +2", [
        {"type": "lateral", "target": "p2", "kind": "length", "delta": 2.0},
    ]),

    # c_m15: phase closer to 60, leakage still high.
    ("crot_m15", "p1L_m2_p2L_p2", "deeper 60-bin, length contrast recovery", [
        {"type": "lateral", "target": "p1", "kind": "length", "delta": -2.0},
        {"type": "lateral", "target": "p2", "kind": "length", "delta": 2.0},
    ]),
    ("crot_m15", "p1W_m2_p2W_p2", "deeper 60-bin, width contrast recovery", [
        {"type": "lateral", "target": "p1", "kind": "width", "delta": -2.0},
        {"type": "lateral", "target": "p2", "kind": "width", "delta": 2.0},
    ]),
    ("crot_m15", "p2W_p2", "deeper 60-bin, p2 width +2", [
        {"type": "lateral", "target": "p2", "kind": "width", "delta": 2.0},
    ]),
    ("crot_m15", "p2L_p2", "deeper 60-bin, p2 length +2", [
        {"type": "lateral", "target": "p2", "kind": "length", "delta": 2.0},
    ]),
]
...
def main() -> int:
    ...
    for base_key, variant_id, purpose, ops in VARIANTS:
        ...
        candidate_id = sanitize(f"p191_h320_p060_{base_key}_{variant_id}")
        config_path = CONFIG_DIR / f"{candidate_id}.yaml"

        cfg.setdefault("project", {})
        cfg["project"]["stage"] = "p191_h320_p060_leakage_recovery"
        ...
        cfg["boundary"]["p191_p060_leakage_recovery"] = True

        cfg.setdefault("metadata", {})
        cfg["metadata"]["p191_base_key"] = base_key
        cfg["metadata"]["p191_base_candidate_id"] = base_id
        cfg["metadata"]["p191_variant_id"] = variant_id
        cfg["metadata"]["p191_purpose"] = purpose
        cfg["metadata"]["p191_fixed_height_nm"] = FIXED_H
        cfg["metadata"]["p191_ops"] = ops
        cfg["metadata"]["p191_changed_fields"] = changed[:50]
