...
PLAN = ROOT / "outputs/apcd_k6_active_learning/p187_fixed_height_platform_scan_plan.csv"
OUT = ROOT / "outputs/apcd_k6_active_learning/p187_fixed_height_platform_scan_results.csv"
DEC = ROOT / "outputs/apcd_k6_active_learning/p187_fixed_height_platform_scan_decision.csv"
MD = ROOT / "reports/p187_fixed_height_platform_scan_results.md"
...
def main() -> int:
    ...
    for p in plan:
        ...
        rows.append({
            ...
            "source_bin_deg": p["source_bin_deg"],
    ...
    for d in decision:
        lines.append(
            f"| {d['fixed_height_nm']} | {d['tested_count']} | {d['valid_count']} | "
    ...
    for r in rows:
        lines.append(
            f"| {r['fixed_height_nm']} | {r['source_bin_deg']} | {r['status']} | "
