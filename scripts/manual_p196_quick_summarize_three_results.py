...
RESULTS = [
    ROOT / r"outputs\apcd_k6_metagrating_633nm\phase_state_candidates\cpk_p196_zgap_dx_in_01\results.csv",
    ROOT / r"outputs\apcd_k6_metagrating_633nm\phase_state_candidates\cpk_p196_zhelper_mid_10\results.csv",
    ROOT / r"outputs\apcd_k6_metagrating_633nm\phase_state_candidates\cpk_p196_zbal_geom_a_11\results.csv",
]
